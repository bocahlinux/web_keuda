...
class Pg_info_cpt extends CI_Controller {
	...
	function pkb()
	{
        ...
        $d['footer']		= $this->site->get_footer("title='footer'");
		$d['content']		= 'site/view_info_cepat/v_pkb';
	...
	function njkb()
	{
		...
		$d['alamat_badan']	= $this->site->get_footer("title='alamat'");
        $d['footer']		= $this->site->get_footer("title='footer'");
		$d['content']		= 'site/view_info_cepat/v_info_njkb';
	...
	function cari_dt_njkb()
	{
		...
		$this->load->view('view_info_cepat/v_det_njkb',$dt);
	}
